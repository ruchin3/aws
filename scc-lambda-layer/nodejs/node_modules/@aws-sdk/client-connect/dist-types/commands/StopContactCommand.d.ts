...
declare const StopContactCommand_base: {
    new (input: StopContactCommandInput): import("@smithy/smithy-client").CommandImpl<StopContactCommandInput, StopContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: StopContactCommandInput): import("@smithy/smithy-client").CommandImpl<StopContactCommandInput, StopContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class StopContactCommand extends StopContactCommand_base {
}
