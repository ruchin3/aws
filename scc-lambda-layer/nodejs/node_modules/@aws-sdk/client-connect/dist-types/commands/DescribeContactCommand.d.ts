...
declare const DescribeContactCommand_base: {
    new (input: DescribeContactCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeContactCommandInput, DescribeContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeContactCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeContactCommandInput, DescribeContactCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
