...
declare const DescribeHoursOfOperationCommand_base: {
    new (input: DescribeHoursOfOperationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeHoursOfOperationCommandInput, DescribeHoursOfOperationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeHoursOfOperationCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeHoursOfOperationCommandInput, DescribeHoursOfOperationCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
