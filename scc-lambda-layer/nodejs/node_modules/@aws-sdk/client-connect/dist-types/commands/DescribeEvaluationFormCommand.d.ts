...
declare const DescribeEvaluationFormCommand_base: {
    new (input: DescribeEvaluationFormCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeEvaluationFormCommandInput, DescribeEvaluationFormCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeEvaluationFormCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeEvaluationFormCommandInput, DescribeEvaluationFormCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
