...
declare const SearchRoutingProfilesCommand_base: {
    new (input: SearchRoutingProfilesCommandInput): import("@smithy/smithy-client").CommandImpl<SearchRoutingProfilesCommandInput, SearchRoutingProfilesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: SearchRoutingProfilesCommandInput): import("@smithy/smithy-client").CommandImpl<SearchRoutingProfilesCommandInput, SearchRoutingProfilesCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class SearchRoutingProfilesCommand extends SearchRoutingProfilesCommand_base {
}
