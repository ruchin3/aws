...
declare const CreatePromptCommand_base: {
    new (input: CreatePromptCommandInput): import("@smithy/smithy-client").CommandImpl<CreatePromptCommandInput, CreatePromptCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: CreatePromptCommandInput): import("@smithy/smithy-client").CommandImpl<CreatePromptCommandInput, CreatePromptCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
