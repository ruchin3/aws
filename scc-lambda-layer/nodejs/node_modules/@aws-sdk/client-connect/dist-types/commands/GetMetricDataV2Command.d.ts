...
declare const GetMetricDataV2Command_base: {
    new (input: GetMetricDataV2CommandInput): import("@smithy/smithy-client").CommandImpl<GetMetricDataV2CommandInput, GetMetricDataV2CommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: GetMetricDataV2CommandInput): import("@smithy/smithy-client").CommandImpl<GetMetricDataV2CommandInput, GetMetricDataV2CommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @public
 */
export declare class GetMetricDataV2Command extends GetMetricDataV2Command_base {
}
