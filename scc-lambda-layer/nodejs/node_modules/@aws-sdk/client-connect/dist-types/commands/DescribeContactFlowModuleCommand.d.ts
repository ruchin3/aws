...
declare const DescribeContactFlowModuleCommand_base: {
    new (input: DescribeContactFlowModuleCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeContactFlowModuleCommandInput, DescribeContactFlowModuleCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeContactFlowModuleCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeContactFlowModuleCommandInput, DescribeContactFlowModuleCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
