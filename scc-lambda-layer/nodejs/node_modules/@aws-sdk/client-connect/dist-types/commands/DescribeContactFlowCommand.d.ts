...
declare const DescribeContactFlowCommand_base: {
    new (input: DescribeContactFlowCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeContactFlowCommandInput, DescribeContactFlowCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (__0_0: DescribeContactFlowCommandInput): import("@smithy/smithy-client").CommandImpl<DescribeContactFlowCommandInput, DescribeContactFlowCommandOutput, ConnectClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
