...
export interface Connect {
     ...
     */
    createViewVersion(args: CreateViewVersionCommandInput, options?: __HttpHandlerOptions): Promise<CreateViewVersionCommandOutput>;
    createViewVersion(args: CreateViewVersionCommandInput, cb: (err: any, data?: CreateViewVersionCommandOutput) => void): void;
    createViewVersion(args: CreateViewVersionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: CreateViewVersionCommandOutput) => void): void;
    /**
     ...
     */
    deleteViewVersion(args: DeleteViewVersionCommandInput, options?: __HttpHandlerOptions): Promise<DeleteViewVersionCommandOutput>;
    deleteViewVersion(args: DeleteViewVersionCommandInput, cb: (err: any, data?: DeleteViewVersionCommandOutput) => void): void;
    deleteViewVersion(args: DeleteViewVersionCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: DeleteViewVersionCommandOutput) => void): void;
    /**
     ...
     */
    listTrafficDistributionGroupUsers(args: ListTrafficDistributionGroupUsersCommandInput, options?: __HttpHandlerOptions): Promise<ListTrafficDistributionGroupUsersCommandOutput>;
    listTrafficDistributionGroupUsers(args: ListTrafficDistributionGroupUsersCommandInput, cb: (err: any, data?: ListTrafficDistributionGroupUsersCommandOutput) => void): void;
    listTrafficDistributionGroupUsers(args: ListTrafficDistributionGroupUsersCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: ListTrafficDistributionGroupUsersCommandOutput) => void): void;
    /**
     ...
     */
    updateViewContent(args: UpdateViewContentCommandInput, options?: __HttpHandlerOptions): Promise<UpdateViewContentCommandOutput>;
    updateViewContent(args: UpdateViewContentCommandInput, cb: (err: any, data?: UpdateViewContentCommandOutput) => void): void;
    updateViewContent(args: UpdateViewContentCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: UpdateViewContentCommandOutput) => void): void;
    /**
